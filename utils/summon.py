...
class Summon:
    ...
    async def on_yes(self, interaction: discord.Interaction):
        ...
        await interaction.message.edit(content = "https://tenor.com/view/aight-bet-aight-bet-cat-gif-25610485")

    async def on_no(self, interaction: discord.Interaction):
        self.timer_still_going = False
        self.user_responed = True
        await interaction.response.defer()
        await interaction.message.edit(content = "https://tenor.com/view/sad-face-ok-cute-baby-gif-14541209")
